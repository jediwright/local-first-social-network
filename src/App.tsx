  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {view === 'pings'    && <PlaceholderView name="Pings — Phase 2" />}
        {view === 'channels' && <PlaceholderView name="Channels — Phase 2" />}
      ...
      <nav className="border-t border-gray-800 flex">
        {NAV_ITEMS.map(({ id, label, icon, phase }) => (
          <button
            ...
            disabled={phase > 1 && id !== 'profile'}
            title={phase > 1 ? `Phase ${phase}` : label}
          >
